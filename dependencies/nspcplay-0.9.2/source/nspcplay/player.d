...
struct NSPCPlayer {
	...
	public void setChannelEnabled(ubyte channel, bool enabled) @safe nothrow pure {
		// Channel controls can be updated while no song is loaded. In that state
		// initialize() has intentionally left the channel array empty, so there is
		// nothing to enable or disable yet.
