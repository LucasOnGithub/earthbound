...
unittest {
	...
	runTestSimple([ // MOV X 3
		0xCD, 0x01, // MOV X, #1
		0x8D, 0x04, // MOV Y, #4
		0xD9, 0x1C, // MOV $1C+Y, X
		0xE4, 0x20, // MOV A, $20
		0xC5, 0x00, 0x80, // MOV $8000, A
		0xFF, // STOP
	], 0x100);
	...
	runTestSimple([ // MOV [d+X]
		0xCD, 0x10, // MOV X, #10
		0xE8, 0x01, // MOV A, #1
		0x8F, 0x00, 0x20, // MOV $20, #00
		0x8F, 0x80, 0x21, // MOV $21, #80
	...
	runTestSimple([ // MOV Y 3
		0x8D, 0x01, // MOV Y, #1
		0xCD, 0x04, // MOV X, #4
		0xDB, 0x1C, // MOV $1C+X, Y
		0xE4, 0x20, // MOV A, $20
		0xC5, 0x00, 0x80, // MOV $8000, A
		0xFF, // STOP
	], 0x100);
	runTestSimple([ // MOV (d)+Y
		0x8D, 0x10, // MOV Y, #10
		0xE8, 0x01, // MOV A, #1
		0x8F, 0xF0, 0x10, // MOV $10, #F0
		0x8F, 0x7F, 0x11, // MOV $11, #7F
		0xD7, 0x10, // MOV ($10)+Y, A
		0xFF, // STOP
	], 0x100);
	...
	runTestSimple([ // MOV ABS+X
		0xE8, 0x01, // MOV A, #1
		0xCD, 0x01, // MOV X, #1
		0xD5, 0xFF, 0x7F, // MOV $7FFF+X, A
		0xFF, // STOP
	], 0x100);
	runTestSimple([ // MOV ABS+Y
		0xE8, 0x01, // MOV A, #1
		0x8D, 0x01, // MOV Y, #1
		0xD6, 0xFF, 0x7F, // MOV $7FFF+Y, A
		0xFF, // STOP
	], 0x100);
	runTestSimple([ // MOV D
		0xE8, 0x01, // MOV A, #1
	...
	runTestSimple([ // MOV D+X
		0xE8, 0x01, // MOV A, #1
		0xCD, 0x01, // MOV X, #1
		0xD4, 0x1F, // MOV $1F+X, A
		0xE4, 0x20, // MOV A, $20
		0xC5, 0x00, 0x80, // MOV $8000, A
		0xFF, // STOP
	], 0x100);
	runTestSimple([ // basic XCN
		0xE8, 0x10, // MOV A, #10
		0x9F, // XCN
		0xF0, 0x03, // BEQ +3
		0xC5, 0x00, 0x80, // MOV $8000, A
	...
	runTestSimple([ // basic DECW
		0x8F, 0x00, 0x20, // MOV $20, #00
		0x8F, 0x02, 0x21, // MOV $21, #02
		0x1A, 0x20, // DECW $20
		0xE4, 0x21, // MOV A, $21
		0xC5, 0x00, 0x80, // MOV $8000, A
		0xFF, // STOP
	], 0x100);
	runTestSimple([ // basic ADDW
		0x8F, 0x01, 0x20, // MOV $20, #01
		0x8F, 0x00, 0x21, // MOV $21, #00
		0xE8, 0x00, // MOV A, #00
		0x8D, 0x00, // MOV Y, #00
		0x7A, 0x20, // ADDW $20
	...
	runTestSimple([ // ADDW (signed overflow)
		0x8F, 0x02, 0x20, // MOV $20, #02
		0x8F, 0x00, 0x21, // MOV $21, #00
		0xE8, 0xFF, // MOV A, #FF
		0x8D, 0x7F, // MOV Y, #7F
		0x7A, 0x20, // ADDW $20
	...
	runTestSimple([ // MUL
		...
		0x8D, 0x04, // MOV Y, #04
		0xCF, // MUL YA
		0xCC, 0x20, 0x00, // MOV $0020, Y
		0x80, // SETC
		0xA5, 0x20, 0x00, // SBC A, $0020
		0xC5, 0x00, 0x80, // MOV $8000, A
		0xFF, // STOP
	], 0x100);
	runTestSimple([ // ROL
	...
	runTestSimple([ // ASL DP
		0x8F, 0x80, 0x20, // MOV $20, #128
		0x0B, 0x20, // ASL $20
		0x30, 0x09, // BMI +9
		0xD0, 0x07, // BNE +7
		0x90, 0x05, // BCC +5
	...
	runTestSimple([ // ASL DP 2
		0x8F, 0x40, 0x20, // MOV $20, #64
		0x0B, 0x20, // ASL $20
		0x10, 0x0E, // BPL +14
		0xF0, 0x0C, // BEQ +12
		0xB0, 0x0A, // BCS +10
		0x78, 0x80, 0x20, // CMP $20 #128
		0xD0, 0x03, // BNE +3
		0xE8, 0x01, // MOV A, #1
		0xC5, 0x00, 0x80, // MOV $8000, A
		0xFF, // STOP
	], 0x100);
	runTestSimple([ // ASL DP 3
		0x8F, 0x20, 0x20, // MOV $20, #32
		0x0B, 0x20, // ASL $20
		0x30, 0x0E, // BMI +14
		0xF0, 0x0C, // BEQ +12
		0xB0, 0x0A, // BCS +10
		0x78, 0x40, 0x20, // CMP $20 #128
		0xD0, 0x03, // BNE +3
		0xE8, 0x01, // MOV A, #1
		0xC5, 0x00, 0x80, // MOV $8000, A
		0xFF, // STOP
